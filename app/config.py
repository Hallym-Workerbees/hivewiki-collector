...
SOURCE_FAILURE_RETRY_MINUTES = int(os.getenv("SOURCE_FAILURE_RETRY_MINUTES", "5"))
SOURCE_FAILURE_MAX_BACKOFF_MINUTES = int(
    os.getenv("SOURCE_FAILURE_MAX_BACKOFF_MINUTES", "60")
)
