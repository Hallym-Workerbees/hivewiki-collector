...
INITIAL_BACKFILL_LIMIT = int(os.getenv("INITIAL_BACKFILL_LIMIT", "200"))
INCREMENTAL_SCAN_LIMIT = int(os.getenv("INCREMENTAL_SCAN_LIMIT", "50"))
INCREMENTAL_MAX_SCAN_LIMIT = int(os.getenv("INCREMENTAL_MAX_SCAN_LIMIT", "100"))
...
RSS_LIMIT_QUERY_PARAM = os.getenv("RSS_LIMIT_QUERY_PARAM", "row")
